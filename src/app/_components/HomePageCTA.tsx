...
export default function HomePageCTA() {
  ...
  return (
    <section className='max-w-6xl w-full mx-auto px-4 flex gap-8 flex-col md:flex-row md:text-left text-center items-center mb-36'>
      ...
      <div className='flex-1 flex flex-col items-center gap-6 md:items-start lg:ml-12'>
        ...
        <p className='grid gap-6'>
          <span>
            ...
            building scalable and efficient Software solutions or collaborating
