...
export default async function HomePageBento() {
  ...
  return (
    ...
    [mask-image:radial-gradient(300px_500px_at_100%_60%,black_30%,transparent_100%),radial-gradient(300px_500px_at_0%_40%,black_30%,transparent_100%)] hidden lg:block'
      >
        <InteractiveGrid />
      </div>
      <div className='relative z-10 max-w-6xl space-y-6 w-full mx-auto px-4 pb-36'>
        <div className='space-y-2'>
          ...
          <hr className='border-gray-500 max-w-3xl mx-auto' />
        </div>
                ...
                >
                  <div className='flex flex-col gap-4 items-center sm:items-start flex-1'>
                    ...
                    <div className='space-x-2 text-sm'>
                      ...
                      <FormattedDate
                        dateString={article.frontmatter.published}
                      />
                    </div>
                    <div>
